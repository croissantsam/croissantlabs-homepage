...
const Char123LocaleChar125homeRouteRoute = Char123LocaleChar125homeRouteRouteImport.update({
  id: "/{-$locale}/(home)",
  path: "/{-$locale}",
  getParentRoute: () => rootRouteImport,
} as any);
const Char123LocaleChar125homeIndexRoute = Char123LocaleChar125homeIndexRouteImport.update({
  id: "/",
  path: "/",
  getParentRoute: () => Char123LocaleChar125homeRouteRoute,
} as any);
const Char123LocaleChar125homeAppsRoute = Char123LocaleChar125homeAppsRouteImport.update({
  id: "/apps",
  path: "/apps",
  getParentRoute: () => Char123LocaleChar125homeRouteRoute,
} as any);
const Char123LocaleChar125homeContactRoute = Char123LocaleChar125homeContactRouteImport.update({
  id: "/contact",
  path: "/contact",
  getParentRoute: () => Char123LocaleChar125homeRouteRoute,
} as any);
const Char123LocaleChar125homeExploreRoute = Char123LocaleChar125homeExploreRouteImport.update({
  id: "/explore",
  path: "/explore",
  getParentRoute: () => Char123LocaleChar125homeRouteRoute,
} as any);
...
export interface FileRouteTypes {
  ...
  to: "/" | "/{-$locale}/apps" | "/{-$locale}/contact" | "/{-$locale}/explore" | "/{-$locale}";
  id:
    | "__root__"
    | "/"
    | "/{-$locale}/(home)"
...
const Char123LocaleChar125homeRouteRouteWithChildren =
  Char123LocaleChar125homeRouteRoute._addFileChildren(Char123LocaleChar125homeRouteRouteChildren);

const rootRouteChildren: RootRouteChildren = {
  IndexRoute: IndexRoute,
  Char123LocaleChar125homeRouteRoute: Char123LocaleChar125homeRouteRouteWithChildren,
};
